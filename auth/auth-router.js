...
router.put("/users/:id", restrict, async (req, res, next) => { // updates user info and returns newly updated user
  try{
    const payload = {
...
router.get("/plants/:id", restrict, async (req, res, next) => { // returns list of plants for specified user
  try {
...
router.put("/plants/:id", restrict, async (req, res, next) => { // updates plant and returns newly updated plant
  try {
...
router.delete("/plants/:id", restrict, async (req, res, next) => { // deletes plant returns deleted plant object
  try {
